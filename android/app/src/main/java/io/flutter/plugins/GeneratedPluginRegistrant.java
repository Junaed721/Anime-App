...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.prasas.aespack.aespack.AespackPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin aespack, com.prasas.aespack.aespack.AespackPlugin", e);
    }
    try {
